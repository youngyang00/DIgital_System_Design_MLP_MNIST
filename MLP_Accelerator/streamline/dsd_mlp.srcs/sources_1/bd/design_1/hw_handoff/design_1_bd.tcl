...
proc create_root_design { parentCell } {
  ...
  set done_led_o [ create_bd_port -dir O done_led_o ]
  ...
  # Create instance: top_mlp_0, and set properties
  set block_name top_mlp
  set block_cell_name top_mlp_0
  if { [catch {set top_mlp_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins smartconnect_0/aclk] [get_bd_pins top_mlp_0/clk]
  connect_bd_net -net rst_n_1 [get_bd_ports rst_n] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins top_mlp_0/rst_n]
  connect_bd_net -net start_i_1 [get_bd_ports start_i] [get_bd_pins top_mlp_0/start_i]
  connect_bd_net -net top_mlp_0_done_led_o [get_bd_ports done_led_o] [get_bd_pins top_mlp_0/done_led_o]
  connect_bd_net -net top_mlp_0_mlp_done [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins top_mlp_0/done_intr_o]
  connect_bd_net -net top_mlp_0_y_buf_addr [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins top_mlp_0/y_buf_addr]
  connect_bd_net -net top_mlp_0_y_buf_data [get_bd_pins axi_bram_ctrl_0_bram/dinb] [get_bd_pins top_mlp_0/y_buf_data]
  connect_bd_net -net top_mlp_0_y_buf_en [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins top_mlp_0/y_buf_en]
  connect_bd_net -net top_mlp_0_y_buf_wr_en [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins top_mlp_0/y_buf_wr_en]
